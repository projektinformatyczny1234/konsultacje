...
<body>
    ...
    <div class="content" style="text-align:center; padding-top:100px">
        <br><br>
        <img src="images/check.png" width=250px height=250px>
        <h1>Twoje zgłoszenie zostało przyjęte!</h1><br><br>
        <h3 style="display:none">Możesz sprawdzić szczegóły na swoim koncie.</h3><br>
        <div class="przycisk1" style="display:none">Sprawdź szczegóły</div><br>
        <div class="przycisk2" style="display:none">Wyloguj się</div>
